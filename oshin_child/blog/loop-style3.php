...
/*  Style 3 (masonary)
* Mods
* 19Oct16 zig - remove link on title (if single?)
* 20Oct16 zig - dont print tags if there arent any.
*/
				...
				<header class="post-header clearfix">
					<?php
						if( $post_format == 'quote' || $post_format == 'link' ) :
							...
							/* zig xout echo '<h5 class="post-title"><a href="'.get_permalink(get_the_ID()).'">'.get_the_title(get_the_ID()).'</a></h5>'; */
